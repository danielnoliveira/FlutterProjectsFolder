...
import 'package:mobx_counter_app/store/todo.dart';
...
abstract class _TodoList with Store {
  ...
  @computed
  ObservableList<Todo> get pendingTodos => ObservableList.of(todos.where((todo) => !todo.done));
  @computed
  ObservableList<Todo> get completedTodos => ObservableList.of(todos.where((todo) => todo.done));
